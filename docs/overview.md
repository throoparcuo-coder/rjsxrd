...
- **Автоматическая верификация конфигов** через Xray-core (v2rayN-стиль батч-тестирование)
...
- **Оптимизированная производительность**:
  ...
  - v2rayN-стиль батч-тестирование (1 процесс Xray, 100 inbound'ов на батч)
